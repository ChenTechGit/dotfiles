...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", height = 23, screen = s })
...
-- Audio controls
local audio_delay = 0.01
audiokeys = gears.table.join(
  awful.key({}, "XF86AudioRaiseVolume",
    function() awful.spawn.with_shell("sleep " .. audio_delay .. "&& pactl set-sink-volume @DEFAULT_SINK@ +5%", false) end,
    { description = "volume up", group = "audio" }),
  awful.key({}, "XF86AudioLowerVolume",
    function() awful.spawn.with_shell("sleep " .. audio_delay .. "&& pactl set-sink-volume @DEFAULT_SINK@ -5%", false) end,
    { description = "volume down", group = "audio" }),
  awful.key({}, "XF86AudioMute",
    function() awful.spawn.with_shell("sleep " .. audio_delay .. "&& pactl set-sink-mute @DEFAULT_SINK@ toggle", false) end,
